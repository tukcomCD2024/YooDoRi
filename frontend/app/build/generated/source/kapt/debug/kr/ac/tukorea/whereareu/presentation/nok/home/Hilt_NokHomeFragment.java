...
public abstract class Hilt_NokHomeFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_NokHomeFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NokHomeFragment_GeneratedInjector) this.generatedComponent()).injectNokHomeFragment(UnsafeCasts.<NokHomeFragment>unsafeCast(this));
    }
  }

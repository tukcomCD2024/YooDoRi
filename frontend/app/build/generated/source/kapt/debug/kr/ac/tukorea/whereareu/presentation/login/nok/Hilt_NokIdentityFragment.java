...
public abstract class Hilt_NokIdentityFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_NokIdentityFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NokIdentityFragment_GeneratedInjector) this.generatedComponent()).injectNokIdentityFragment(UnsafeCasts.<NokIdentityFragment>unsafeCast(this));
    }
  }

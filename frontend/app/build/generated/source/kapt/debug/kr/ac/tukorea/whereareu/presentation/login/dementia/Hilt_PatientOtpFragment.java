...
public abstract class Hilt_PatientOtpFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PatientOtpFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientOtpFragment_GeneratedInjector) this.generatedComponent()).injectPatientOtpFragment(UnsafeCasts.<PatientOtpFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_DementiaSettingFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_DementiaSettingFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DementiaSettingFragment_GeneratedInjector) this.generatedComponent()).injectDementiaSettingFragment(UnsafeCasts.<DementiaSettingFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_LoginFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginFragment_GeneratedInjector) this.generatedComponent()).injectLoginFragment(UnsafeCasts.<LoginFragment>unsafeCast(this));
    }
  }

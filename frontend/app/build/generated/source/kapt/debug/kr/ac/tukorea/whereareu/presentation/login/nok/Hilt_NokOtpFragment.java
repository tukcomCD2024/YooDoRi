...
public abstract class Hilt_NokOtpFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_NokOtpFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NokOtpFragment_GeneratedInjector) this.generatedComponent()).injectNokOtpFragment(UnsafeCasts.<NokOtpFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_PredictLocationFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PredictLocationFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PredictLocationFragment_GeneratedInjector) this.generatedComponent()).injectPredictLocationFragment(UnsafeCasts.<PredictLocationFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_PatientIdentifyFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PatientIdentifyFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientIdentifyFragment_GeneratedInjector) this.generatedComponent()).injectPatientIdentifyFragment(UnsafeCasts.<PatientIdentifyFragment>unsafeCast(this));
    }
  }
